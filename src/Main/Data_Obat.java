   ...
   DefaultTableModel model;
    ...
    private void tampilkan() {
        ...
        Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/dbapotik","root","");
         ResultSet rs= cn.createStatement().executeQuery("SELECT * FROM tb_dataobat");
         while(rs.next()){
    ...
    private void initComponents() {
        ...
        Print.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/print_filled_20px.png"))); // NOI18N
        Print.setText("PRINT");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(txtstok, javax.swing.GroupLayout.DEFAULT_SIZE, 150, Short.MAX_VALUE)
                                .addComponent(tglExp, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(rjk1)
                                    .addComponent(rjk3))
    ...
    private void SimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SimpanActionPerformed
       ...
       if(rjk1.isSelected()){
           ...
           bgjenis="SIRUP";
            ...
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/dbapotik","root","");
            cn.createStatement().executeUpdate("insert into tb_dataobat values"+"('"
                    +txtkode.getText()
                    +"','"+txtnama.getText()
                    +"','"+txtharga.getText()
                    +"','"+tanggal
    ...
    private void UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateActionPerformed
       ...
       if(rjk1.isSelected()){
           ...
           Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/dbapotik","root","");
            cn.createStatement().executeUpdate("update tb_dataobat set nama='"
                    +txtnama.getText()
    ...
    private void tglExpPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_tglExpPropertyChange
        ...
        if(tglExp.getDate() != null){
            ...
            tanggal= String.valueOf(format.format(tglExp.getDate()));
        }
        }catch(Exception e){}
    ...
    private void tblobatMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblobatMouseClicked
        ...
        txtstok.setText(model.getValueAt(i,4).toString());
        String bgjenis= model.getValueAt(i,5).toString();
        if(bgjenis.equals("TABLET")){
        rjk1.setSelected(true);
        }else if(bgjenis.equals("KAPSUL")){
        rjk2.setSelected(true);
        }else if(bgjenis.equals("CAIR")){
        rjk3.setSelected(true);
        }else if(bgjenis.equals("PIL")){
    ...
    private void HapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HapusActionPerformed
         try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/dbapotik","root","");
            cn.createStatement().executeUpdate("delete from tb_dataobat where kode='"+txtkode.getText()+"'");
            tampilkan();
             reset();
        } catch (SQLException ex) {
            Logger.getLogger(Data_Obat.class.getName()).log(Level.SEVERE, null, ex);
